      ...
      <section className=" w-full mx-auto flex flex-col-reverse gap-[40px] md:flex-row my-[30px] ">
        <div className="flex flex-col justify-start w-full">
          ...
          <Link href="/contactus">
            <button
              type="button"
              className="flex gap-2 items-center text-darkgot text-[14px]  h-[40px] stroke-darkgot hover:stroke-gotimate hover:text-gotimate transition-all rounded-[10px]"
            >
              {t('haveAquestionBtn')}
              <svg
                width="7"
      ...
      <section className="flex flex-col gap-3">
        ...
        <section className="w-full flex flex-col gap-[70px] md:flex-row justify-center items-center md:my-9">
          ...
          <section className=" relative flex flex-col gap-3 flex-1 team-card">
            <div className="relative overflow-hidden rounded-full rounded-tr-none max-w-[300px] h-auto h-auto team-img">
        ...
        <section className="flex flex-col gap-[70px] md:flex-row justify-center items-center md:my-9">
          {/* card start */}
          <section className=" relative flex flex-col justify-center items-center gap-3 flex-1 team-card">
            <div className="relative overflow-hidden rounded-full rounded-tr-none  max-w-[300px] h-auto team-img">
