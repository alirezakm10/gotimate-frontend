  ...
  return (
    <section className="flex flex-col md:flex-row h-auto gap-3">
      <div className="flex flex-col gap-[30px]">
        ...
        <button
              type="button"
              className="flex gap-3 items-center text-white bg-cyan-800 hover:bg-gray-400 transition-all focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-3xl text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800"
            >
